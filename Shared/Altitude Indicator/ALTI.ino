...
#include <gfxfont.h>
#include <Fonts/MS3355810pt7b.h>
#define OLED_Address 0x3C
Adafruit_SSD1306 display(128, 64, &Wire, -1);

DcsBios::ServoOutput wsoBaroStandby(0x2bc2, 5, 850, 1600);

DcsBios::RotaryEncoder wsoBaroPressureKnob("WSO_BARO_PRESSURE_KNOB", "-20", "+20", 14, 15);

DcsBios::Switch3Pos wsoBaroMode("WSO_BARO_MODE", 3, 4);

void onWsoBaroPressureChange(char* newValue) {
...
DcsBios::StringBuffer<4> wsoBaroPressureBuffer(0x2bbe, onWsoBaroPressureChange);
...
AccelStepper stepper(AccelStepper::FULL4WIRE, 12, 11, 9, 10);
// define Vid60Stepper class that uses the AccelStepper instance defined in the line above
//           v-- arbitrary name
Vid60Stepper wsoBaroNeedle(0x2bb8,          // address of stepper data
